                ...
                <div class="text-center">
                        ...
                        <div class="form-row">
                            <div class="col">
                                <div class="form-group">
                                    <label>Cédula</label>
                                    <input type="text" class="form-control" placeholder="999-999999-9999A" pattern="^[0-9]{3}-[0-9]{6}-[0-9]{4}[a-zA-Z]{1}$" name="identify">
                                </div>
                            </div>
                            <div class="col">
                                <div class="form-group">
                        ...
                        <div class="social-login-content">
                            <div class="social-button">
                                <button type="button" class="btn social facebook btn-flat btn-addon mb-3">Cancelar</button>
                            </div>
                        </div>
                    </form>
                </div>
